...
mod tests {
    ...
    fn test_multiple_swaps() {
        ...
        let swap_id_0 = client.initiate_swap(&token_id, &ip_id_0, &seller, &1000_i128, &buyer, &0_u32, &None, &false);
        let swap_id_1 = client.initiate_swap(&token_id, &ip_id_1, &seller, &1000_i128, &buyer, &0_u32, &None, &false);
