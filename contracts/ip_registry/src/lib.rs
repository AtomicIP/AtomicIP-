...
pub enum ContractError {
    ...
    /// #809: OwnershipShare percentages for an IP do not sum to exactly 100.
    InvalidShareTotal = 36,
}
...
pub enum DataKey {
    ...
    ExpiryNotified(u64),
    // Issue #809: stores Vec<OwnershipShare> cap table (owner + co-owners) for a given IP
    OwnershipShares(u64),
}
